        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    atv_conv = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    atv_plano = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    atv_tipo = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    fantasia_emp = table.Column<string>(maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "proced_sinonimo",
                columns: table => new
                {
                    cod_tipproced = table.Column<int>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    nom_tipproced_sinonimo = table.Column<string>(maxLength: 200, nullable: false),
                    atv_tipo_proce_sinonimo = table.Column<int>(nullable: false),
                    ProcedimentoID = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_proced_sinonimo", x => x.cod_tipproced);
                    table.ForeignKey(
                        name: "FK_proced_sinonimo_proced_ProcedimentoID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    imgthumb_procemp = table.Column<string>(maxLength: 100, nullable: true),
                    imghome_procemp = table.Column<string>(maxLength: 100, nullable: true),
                    imgmain_procemp = table.Column<string>(maxLength: 100, nullable: true),
                    video_procemp = table.Column<string>(maxLength: 100, nullable: true),
                    atv_proced = table.Column<int>(nullable: false),
                    dest_proced = table.Column<int>(nullable: false),
                    cod_proced = table.Column<int>(nullable: false),
                    cod_emp = table.Column<int>(nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_proced_sinonimo_ProcedimentoID",
