...
namespace database.portal.jenn.Migrations
{
    ...
    [Migration("20200822201924_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("api.portal.jenn.DTO.ProcedimentoSinonimo", b =>
                {
                    b.Property<int>("ProcedimentoSinonimoID")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("cod_tipproced")
                        .HasColumnType("int");

                    b.Property<int>("Ativo")
                        .HasColumnName("atv_tipo_proce_sinonimo")
                        .HasColumnType("int");

                    b.Property<string>("Nome")
                        .IsRequired()
                        .HasColumnName("nom_tipproced_sinonimo")
                        .HasColumnType("varchar(200) CHARACTER SET utf8mb4")
                        .HasMaxLength(200);
                    ...
                    b.HasKey("ProcedimentoSinonimoID");

                    b.HasIndex("ProcedimentoID");

                    b.ToTable("proced_sinonimo");
                });
            ...
            modelBuilder.Entity("api.portal.jenn.DTO.ProcedimentoSinonimo", b =>
                {
                    b.HasOne("api.portal.jenn.DTO.Procedimento", "Procedimento")
                        .WithMany("ProcedimentoSinonimos")
                        .HasForeignKey("ProcedimentoID");
                });
