...
namespace api.portal.jenn.factory
{
    ...
    public class ProcedimentoContextFactory : IDesignTimeDbContextFactory<DBJennContext>
    {
        private readonly IHostEnvironment environment;
        private readonly IConfiguration config;

        public ProcedimentoContextFactory(IHostEnvironment _environment, IConfiguration _config)
        {
