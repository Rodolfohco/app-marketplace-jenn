...
{
    public class ClienteContextFactory : IDesignTimeDbContextFactory<DBJennContext>
    {
        private readonly IHostEnvironment environment;
        private readonly IConfiguration config;

        public ClienteContextFactory(IHostEnvironment _environment, IConfiguration _config)
        {
